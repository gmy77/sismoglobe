...
- punti fusi in un'unica geometria (`pointsMerge`) quando gli eventi visibili superano i 600. **Limite noto:** con i punti fusi globe.gl non distingue più i singoli eventi, quindi nelle viste a 7 e 30 giorni si perdono il tooltip al passaggio del mouse e il clic sull'epicentro (nella vista a 24 ore, che resta sotto la soglia, funzionano normalmente). La lista laterale resta cliccabile in ogni vista;
